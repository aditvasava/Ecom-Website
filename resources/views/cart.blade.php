<html>
  ...
  <body>
    ...
    <div class="searchwr">
              <div class="trenwrap">
                  <p style="letter-spacing:1px;font-size:25px;margin-top:2px;margin-left:5px;">Items in your cart.</p><br><br>
                  @foreach($products as $item)
                            <div class="searchitem">
                              <a href="detail/{{$item->id}}">
                              <img class="trenimage" src="{{$item->gallery}}"><br><br>
                              <div class="searchnamecart">
                              {{$item->name}}
                              </div>
                            </a>
                            <div class="qnty">
                            ...
                            <br><br>
                            @endforeach
                              <a class="btn btn-success" href="/order" style="width:200px;margin-left:10px;">Order Now</a> <br> <br>
      </div>
